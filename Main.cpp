...
void info() {
	cout << "\t\t\t\t\t-----WELCOME TO THE SMASHING FOUR!-----" << endl;
	...
	cout << "\n------------------------------------------------------------------------------------------------------------------------" << endl;
	this_thread::sleep_for(0.5s);
	cout << "\n\t\t\t\t\t\tFIRE SPIN ARENA" << endl;
	this_thread::sleep_for(0.5s);
	cout << "\n------------------------------------------------------------------------------------------------------------------------" << endl;
	cout << "\nFire Meteorite Arena: Attack(20 pure damage) each unit on the field after each round" << endl;
	cout << "\nAttack Chance: %10" << endl;
	cout << "\n------------------------------------------------------------------------------------------------------------------------" << endl;
	this_thread::sleep_for(0.5s);
	cout << "\n\t\t\t\t\t\tVALHALLA ARENA" << endl;
	this_thread::sleep_for(0.5s);
	cout << "\n------------------------------------------------------------------------------------------------------------------------" << endl;
	cout << "\nValhalla Arena: Resurrecting the death units with %10 of their HP after each round" << endl;
	cout << "\nResurrecting Chance: %5" << endl;
	cout << "\n------------------------------------------------------------------------------------------------------------------------" << endl;
	this_thread::sleep_for(0.5s);
}
